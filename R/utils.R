...
theme_custom <- function(scale_f = 1, ...) {
  theme_gray() +
    theme(
      ...
      plot.subtitle = element_text(size = 10*scale_f, face = 'bold', hjust = 0),
      plot.title = element_text(size = 9*scale_f, hjust = 0, face = 'bold', color = '#0496FF'),
      ...
      axis.text = element_text(size=9*scale_f, color = "black", face = "bold"),
